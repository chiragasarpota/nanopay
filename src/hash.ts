...
const { blake2bFinal, blake2bInit, blake2bUpdate } = blake

import { checkAddress, checkAmount, checkHash } from './check.js'

import { convert, Unit } from './conversion.js'
...
export interface HashBlockParams {
   ...
   *
   * Read more on the [official Nano block documentation](https://docs.nano.org/protocol-design/blocks/)
   */
  link: string
}
